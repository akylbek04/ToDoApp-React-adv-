...
class App extends React.Component {
  ...
  handleEdit = (inputEditVal, editId) => {
    const { todos } = this.state;
    const updatedArr = todos.map((todo) => 
      todo.id === editId ? {...todo, name: inputEditVal} : todo
    );
    this.setState(prevState => {
      return({
        ...prevState,
  ...
  render() {
    const { todos, inputVal } = this.state;
    const { handleAddTodo, handleInputChange, handleDeleteTodo, handleEdit } =
      this;
